...
namespace cloud.charging.open.Gateway
{
    ...
    /// <summary>
    /// What time this gateway thinks it is, and what that is worth.
    /// </summary>
    /// <remarks>
    /// Two different questions, and a gateway has to keep them apart.
    ...
    /// **this gateway does not set its clock from the answer**. It measures the
    ...
    /// <c>nts.legalTimeAuthority</c>, and this gateway then only repeats that
    ...
    /// gateway that has not checked, and the whole point of not printing the
    /// word "legal" over it.
    /// </remarks>
    public partial class Gateway
    {
        ...
        /// <summary>
        /// How often this gateway checks its clock.
        /// </summary>
        ...
        /// <summary>
        /// How far this gateway's clock may be off and still count.
        /// </summary>
        ...
        /// <summary>
        /// Begin checking this gateway's clock against its time server.
        /// </summary>
        /// <remarks>
        /// Through the gateway's own <see cref="TimeProvider"/> rather than a
        ...
        private void StartCheckingTheClock()
        {
            ...
            if (!NTSEnabled)
            {
                Log.Info("The clock of this gateway is not being checked: NTS is switched off.", "nts", "clock");
                return;
            }
        ...
        private async Task CheckTheClockAsync()
        {
            ...
            try
            {
                ...
                if (result.Value<Boolean>("ok") != true)
                    Log.Warning(
                        $"The clock of this gateway could not be checked: {result.Value<String>("error") ?? "no answer"}.",
                        "nts", "clock"
                    );
            ...
            {
                Log.Warning($"The clock of this gateway could not be checked: {e.Message}", "nts", "clock");
            }
        ...
        public JObject ClockJSON()
        {
            ...
            return new JObject(
                       ...
                       // Said out loud: the number above is this gateway's own
