...
namespace cloud.charging.open.Gateway.Configuration
{
    ...
    /// </summary>
    /// <remarks>
    /// Three rules, and they are the same for every field this gateway reads
    ...
    public static class ConfigurationReader
    {
        ...
        /// <summary>
        /// An optional number within a range: a timeout in seconds, a count
        /// of retries.
        /// </summary>
        /// <remarks>
        /// The range is part of the read rather than checked afterwards,
        /// because every one of these has a range the thing it describes cannot
        /// sensibly leave - a timeout of -3 seconds, a thousand retries - and a
        /// figure outside it is a typing mistake rather than an unusual setup.
        /// </remarks>
