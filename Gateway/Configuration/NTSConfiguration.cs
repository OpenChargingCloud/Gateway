...
namespace cloud.charging.open.Gateway.Configuration
{

    /// <summary>
    /// The "nts" section of the configuration file: where this gateway
    ...
    /// missing keeps whatever the gateway was given at construction.
    /// </remarks>
    /// <param name="Enabled">Whether this gateway asks a time server at all.</param>
    ...
    /// <param name="CheckEvery">How often this gateway checks its clock against that server.</param>
    /// <param name="LegalTimeAuthority">Who stands behind that server's time, e.g. "PTB" - the operator saying so, because this gateway cannot find out by itself.</param>
    /// <param name="LegalTimeTolerance">How far this gateway's own clock may be from it and still count.</param>
    /// <param name="LegalTimeMaxAge">How old the last check may be and still count.</param>
    /// <param name="Servers">Every time server of this gateway, or none to ask only the one named by Hostname.</param>
                                          ...
                                          TimeSpan?                                MaxDeviation          = null)
    {
        ...
        /// <summary>
        /// How often this gateway checks its clock against its time server,
        ...
        /// public time server does not notice this gateway at all.
        /// </remarks>
        public static readonly TimeSpan  DefaultCheckEvery        = TimeSpan.FromMinutes(15);

        /// <summary>
        /// How far this gateway's clock may be from the time it was checked
        ...
        /// <summary>
        /// The time server this gateway asks when nothing says otherwise.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The time servers this gateway asks when its configuration names none.
        /// </summary>
        /// <remarks>
        ...
        /// leave this gateway without a clock, and because two servers that agree
        ...
        /// <summary>
        /// The group a gateway asks when nothing has said otherwise.
        /// </summary>
        ...
        /// <summary>
        /// The time servers of this gateway as a group that can be asked.
        /// </summary>
        /// <remarks>
        ...
        /// gateway asking a second group for load balancing would name that one
        ...
        /// <summary>
        /// The section as it is written to the file; what this gateway was not
