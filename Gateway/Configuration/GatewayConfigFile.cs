...
namespace cloud.charging.open.Gateway.Configuration
{
    ...
    /// <summary>
    /// The configuration of this gateway, in a file beside it.
    /// </summary>
    /// <remarks>
    /// What a gateway is - where it resolves names and reads the time - does
    /// not change between starts and should not have to be repeated at every
    ...
    /// can read the directory may read. The one secret this gateway has, the
    ...
    public sealed class GatewayConfigFile
    {
        ...
        /// </summary>
        public GatewayConfigFile(String Path)
        {
        ...
        /// </summary>
        public Boolean TryLoad([NotNullWhen(true)] out GatewayConfiguration?  Configuration,
                                                   out String?                Error)
        {
            ...
            if (!GatewayConfiguration.TryParse(document, out Configuration, out var problem))
            {
                Error = $"'{Path}': {problem}";
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This is what makes a partial save safe: a gateway that only
                                       ...
                                       [NotNullWhen(false)] out String?   Error)
        {
            ...
            if (!File.Exists(Path))
            {
                // No file is not a failure, it is a gateway nobody has
        ...
        /// rather than half of the new one. A gateway that cannot read
        ...
        /// now - and a file that stops the gateway is worse than a save that
        /// is refused.
        /// </remarks>
                                ...
                                [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // Move, not copy: on every file system this gateway runs on
