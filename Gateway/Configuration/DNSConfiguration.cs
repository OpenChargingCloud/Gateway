...
namespace cloud.charging.open.Gateway.Configuration
{
    ...
    /// <summary>
    /// The "dns" section of the configuration file: how this gateway
    /// resolves names.
    /// </summary>
    /// <remarks>
    /// Every field is optional, and null means "the file does not say" rather
    /// than "the file says nothing": what is missing keeps whatever the gateway
    /// was given at construction, and a gateway given nothing keeps the system
    ...
    /// </remarks>
    /// <param name="Enabled">Whether this gateway resolves names at all.</param>
                                          ...
                                          Byte?                           MaxRetries            = null)
    {
        ...
        /// <summary>
        /// The most name servers one gateway may be given. Not a rule of DNS -
        /// a query goes to all of them at once, and a hundred of them would be
        /// a hundred packets for every name this gateway ever looks up.
        /// </summary>
