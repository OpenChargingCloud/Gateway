...
namespace cloud.charging.open.Gateway.Configuration
{
    ...
    /// <summary>
    /// Everything this gateway can be told in writing: one document with one
    ...
    /// question "what is this gateway configured as" should have one answer
    ...
    /// opinion, and whatever the gateway was handed at construction stands. A
    /// gateway handed nothing either falls back to the system default. So the
    ...
    /// </remarks>
    /// <param name="DNS">How this gateway resolves names.</param>
    /// <param name="NTS">Where this gateway reads the time.</param>
    public sealed record GatewayConfiguration(DNSConfiguration?  DNS  = null,
                                              NTSConfiguration?  NTS  = null)
    {
        ...
        ///
        /// Sections this gateway does not know are passed over without a word.
        /// A file written by a newer gateway should still start an older one,
        /// and the file keeps them - see
        /// <see cref="GatewayConfigFile.TryReplaceSection"/>.
        /// </remarks>
        public static Boolean TryParse(JObject                                        JSON,
                                       [NotNullWhen(true)]  out GatewayConfiguration?  Configuration,
                                       [NotNullWhen(false)] out String?                Error)
        {
            ...
            Configuration = new GatewayConfiguration(dns, nts);
            return true;
