...
namespace cloud.charging.open.Gateway
{
    ...
    /// <summary>
    /// One assembly this gateway is running, and the commit it was built from
    ...
    /// <summary>
    /// What this gateway was built from, read from the assemblies themselves.
    /// </summary>
    /// <remarks>
    ...
    /// either: this repository's own start script still collected a hash for
    /// Urdr, which nothing here has referenced for a long time.
    /// </remarks>
    public static class BuiltFrom
    {
        ...
        private static IReadOnlyList<LoadedAssembly> Collect()
        {
            ...
            // gateway does not reference and would otherwise be missing from its
            ...
            while (queue.Count > 0)
            {
                ...
                foreach (var reference in assembly.GetReferencedAssemblies())
                {
                    ...
                    // depending on how the gateway was started.
                    try
                    {
