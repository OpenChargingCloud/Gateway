...
namespace cloud.charging.open.Gateway
{
    ...
    /// of the gateway got was thirteen frames of stack trace under the
    ...
    /// gateway standing in Germany should not answer in German to somebody
        ...
        private static String Why(SocketError Problem)
            ...
            => Problem switch {
                   ...
                   SocketError.AccessDenied
                       => "the operating system would not let this gateway have it",
