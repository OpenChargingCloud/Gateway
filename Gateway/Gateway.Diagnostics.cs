...
namespace cloud.charging.open.Gateway
{
    ...
    /// <summary>
    /// Making this gateway try something, to find out whether it can:
    ...
    public partial class Gateway
    {
        ...
        /// list - or null for all of them, the way this gateway resolves
        /// anything else.
        /// </param>
                                                ...
                                                CancellationToken                     CancellationToken   = default)
        {
            ...
            if (!DNSEnabled)
            {
                ...
                return Failed(name, asked, "Name resolution is switched off on this gateway.");
            }
            ...
            if (Server is Int32 which)
            {
                ...
                if (which < 0 || which >= configuredDNSServers.Count)
                    return Failed(name, asked, $"This gateway has no name server number {which + 1}.");
            ...
            try
            {
                ...
                // being asked. Everything else is taken from the gateway's own
                // client, so what is being tested is this gateway's settings
        ...
        /// </summary>
        /// <remarks>
        /// The clock of this gateway is not set from the answer, and that is
        ...
        /// Stepping the clock of a running gateway is a different
        ...
        ///
        /// The clock of this gateway is not stepped by any of it, the same as
        /// "Sync now".
        /// </remarks>
        /// <param name="Host">
                                                       ...
                                                       CancellationToken  CancellationToken   = default)
        {
            ...
            if (!NTSEnabled)
            {
                Step("error", "Time synchronisation is switched off on this gateway, so nothing was asked.");
            ...
            try
            {
                ...
                // sentences are English, and a gateway in a German locale
        ...
        /// <summary>
        /// Ask this gateway's group of time servers what the time is.
        /// </summary>
        /// <remarks>
        ...
        public async Task<JObject> SyncTimeAsync(CancellationToken CancellationToken = default)
        {
            ...
            if (!NTSEnabled)
            {
                Log.Warning("Time synchronisation was not run: NTS is switched off on this gateway.", "nts", "test");
                return Failed("NTS is switched off on this gateway.");
            }
