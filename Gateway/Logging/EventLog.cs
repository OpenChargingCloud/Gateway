...
namespace cloud.charging.open.Gateway.Logging
{
    ...
    /// <summary>
    /// Everything that happens inside this gateway, in one place: the
    ...
    /// actually has in front of a gateway is "what happened just now",
    ...
    public sealed class EventLog
    {
        ...
        /// somewhere else than the rest of the gateway is a log that cannot be
        ...
        /// <summary>Something is not as it should be, but the gateway carries on.</summary>
