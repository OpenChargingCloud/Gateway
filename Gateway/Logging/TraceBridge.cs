...
namespace cloud.charging.open.Gateway.Logging
{
    ...
    /// <summary>
    /// Everything the libraries below this gateway write with Illias' DebugX,
    ...
    /// release build shows on the Logs page is what this gateway logs itself.
    ///
    ...
    public sealed class TraceBridge : TraceListener
    {
        ...
        /// tell what the gateway said itself from what it overheard.
        /// </summary>
