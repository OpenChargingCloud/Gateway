...
// by ../Gateway.csproj (target "EmbedFrontend"):
//
...
// server on a second port. A gateway has nobody standing in front of it.
//
...
module.exports = (env, argv) => {
    ...
    return {
        ...
        output: {
            ...
            // and so does the same bundle mounted below /Gateway or /CSMS. An
