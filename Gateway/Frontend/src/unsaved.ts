/**
 * What is on a page that the gateway has not been told about.
 *
...
export const theQuestion = 'There are changes on this page that the gateway has not been told about.\n\n' +
                           'Leave them behind?';
