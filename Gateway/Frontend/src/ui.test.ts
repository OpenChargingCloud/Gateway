...
describe('a page while the gateway is being told', () => {
    ...
    it('comes back when it failed as well, or the page would be dead', async () => {
        ...
        await assert.rejects(() =>
            whileSaving(page(live), note, () => Promise.reject(new Error('the gateway said no'))));
    ...
    it('hands back what the gateway answered, untouched', async () => {
