    ...
    render({ root, url, navigate }) {
        ...
        render(root, html`
            <section class="login">
                ...
                <h1><i class="fa-solid fa-network-wired"></i> Gateway</h1>
                <p class="muted">Sign in to configure this gateway and read its log.</p>
                ...
                <p class="small muted login-hint">
                    The gateway makes up one account at its first start and shows
                    its password once, on the console.
                </p>

                <p class="small muted">gateway ${config.serverVersion} &middot; web ${config.frontendVersion}</p>
