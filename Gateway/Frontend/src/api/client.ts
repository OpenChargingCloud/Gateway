...
/** What may be changed about the time client while the gateway runs. */
...
export interface NTSConfiguration {
    ...
    /** The servers this gateway asks, and the rules for believing them. */
...
export const api = {
    ...
    nts: {
         ...
         * in the log - two steps over the network, so two of the gateway's own
