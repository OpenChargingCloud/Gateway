...
namespace cloud.charging.open.Gateway.Tests
{
    ...
    public class NTSGroupConfigurationTests
    {
        ...
        /// <summary>
        /// What a gateway asks when its configuration says nothing at all.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Three servers and a quorum of four is a gateway that can never have
        ...
        public void WhatIsWrittenComesBack()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                // gateway wrote reads the way somebody would have written it.
